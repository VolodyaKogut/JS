...
//     document.write(`<li><h1>${listOfItems[i]}</h1></li>`);
//
// }
// document.write('</ul>');
...
for (let simpson of simpsons) {
    document.write(`<div>NAME-${simpson.name} SURNAME- ${simpson.surname} AGE-${simpson.age} INFO-${simpson.info} <img src="${simpson.photo}" alt=""> </div>`)
}
